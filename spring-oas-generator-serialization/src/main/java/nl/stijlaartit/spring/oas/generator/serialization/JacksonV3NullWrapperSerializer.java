...
public final class JacksonV3NullWrapperSerializer implements GenerationFileSerializer<NullWrapperFile> {
    ...
    public JacksonV3NullWrapperSerializer(String modelsPackage) {
